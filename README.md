...
<p align="center">
  <a href="docs/videos/ai-parameter-tuning-demo.mp4">
    <img src="docs/images/ai-parameter-tuning-example.jpg" alt="点击播放 Codex AI 调参实例视频" width="720">
  </a>
</p>

<p align="center">
  <a href="docs/videos/ai-parameter-tuning-demo.mp4">▶ 点击播放 AI 调参实例视频</a>
</p>

视频展示的是工作流程实例，具体命令、通道数量和安全边界应按目标设备配置。
